      ...
      <div className="pb-32">
        ...
        <div className="mt-16">
          <div className="mb-24">
            ...
            <p className="p-12 px-32 text-lg text-gray-600">
              ...
              especialidade técnica.  Promovemos, através de parcerias, cursos
              também em áreas relacionadas à ornitologia, conservação e
        ...
        <div className="px-12 sm:px-32">
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="w-full my-auto sm:w-2/3">
              <p className="text-gray-600 ">
                O programa de treinamento em Monitoramento de Avifauna tem como
                objetivo promover capacitação técnica de excelência na área de
                ornitologia de campo e viabilizar a expansão da coleta de dados
                no OAMa com a participação de voluntários em treinamento. O
                currículo do programa inclui aulas teóricas e muita atividade
                prática focadas nas técnicas de captura-marcação-recaptura com
                redes de neblina e anilhamento de aves e de census com pontos
                fixos. O treinamento acontece presencialmente e requer{" "}
                <span className="font-bold">
                  dedicação exclusiva e residência
                </span>{" "}
                na Estação de Pesquisa do OAMa, localizada na Reserva Particular
                do Patrimônio Natural (RPPN) Fazenda Boa Vista, em Bocaina de
                Minas/MG, Serra da Mantiqueira.{" "}
              </p>
              <p className="text-gray-600 ">
                A{" "}
                <span className="font-bold">
          ...
          <div className="flex mb-8 flex-col sm:flex-row ">
            ...
            <div className="w-full  my-auto sm:w-2/3">
              ...
              <p className="text-gray-600 ">
                ...
                terminologias e nomenclaturas para mudas e plumagens em aves, e
                expandir a prática de classificação de idade de aves com base na
                análise de mudas e plumagem entre os ornitólogos do Brasil. O
                tema e o nível do curso pode interessar desde estudantes de
                graduação até pesquisadores e professores que tenham interesse
                no estudo de muda das aves e suas aplicações para classificação
                de idade. Quem não é acadêmico mas é muito curioso e gosta de
                observar aves e suas plumagens também está convidado a
                participar. O curso será ministrado por Luiza Figueira e Pedro
                Martins.{" "}
          ...
          <div className="flex flex-col sm:flex-row ">
            ...
            <div className="w-full sm:w-2/3  my-auto">
              ...
              <p className="text-gray-600 ">
                Esta atividade é voltada para fotógrafos e observadores de aves
                que buscam aprimorar ou iniciar seus registros fotográficos de
                natureza, inclusive as aves. O objetivo deste curso é que o
                participante domine os conceitos da fotografia com qualquer
                marca de equipamento, através de conhecimentos teóricos e
                práticos. Na parte prática o instrutor orienta de forma
                ...
                poderão tirar suas dúvidas particulares e aprender mais sobre
                sua câmera individualmente. Na parte teórica serão trabalhados
                os pilares da fotografia, e técnicas que facilitam na agilidade
                da configuração do equipamento. Além de composição e
                comportamento do fotógrafo.O workshop será ministrado por{" "}
          ...
          <ul className="text-lg p-12">
            ...
            <li className="list-disc">
              Curso prático de análise de muda e classificação de idade em aves
            </li>
          </ul>
          <h2 className="w-full mt-12 mb-6 text-3xl font-bold leading-tight text-center text-gray-800">
            Cursos Concluídos
