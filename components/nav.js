    ...
    >
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        >
          {/* For Hamburguer Menu */}
          {/* <div
          class={`w-full flex-grow lg:flex items-end lg:w-auto ${
            open ? "" : "hidden"
        ...
        > */}
          ...
          <div className="justify-end flex items-end">
            <button
              id="navAction"
              class="mx-auto lg:mx-0 mr-2 hover:underline bg-yellow-400 text-gray-800 font-bold rounded-full mt-0 py-2  px-8 shadow  focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            >
              Doe
            </button>
          </div>
