...
export default function Nav() {
  ...
  return (
    ...
    <nav
      id="header"
      class={`fixed w-full z-50 top-0 text-white ${
        scroll ? "bg-gray-800" : ""
      }`}
    >
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div
          class={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${open?"":"hidden"} mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20`}
          id="nav-content"
          ref={ref}
        >
          ...
          <button
            id="navAction"
            class="mx-auto lg:mx-0 hover:underline bg-yellow-400 text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
            Doe
          </button>
        </div>
