        ...
        < AccordionItem >
            ...
            <AccordionPanel>
                <div className="px-6 pt-4 text-gray-600">
                    ...
                    <Fig section="trafico" objectFit="contain" number={5} legend={
                        <p>
                    ...
                    <H4>Fique esperto</H4>
                    <p>De acordo com o <a href="http://www.planalto.gov.br/ccivil_03/leis/l9605.htm" target="_blank">artigo 29 da lei 9.605 de 1998</a> que trata sobre os Crimes Ambientais, é crime contra a fauna “matar, perseguir, caçar, apanhar, utilizar espécimes da fauna silvestre, nativos ou em rota migratória, sem a devida permissão, licença ou autorização da autoridade competente, ou em desacordo com a obtida”. O Parágrafo 1º destaca ainda que, incorre nas mesmas penas,</p>
                    <span className="p-2">
                    ...
                    <ul>
                        ...
                        <li className="mb-4">Polícia Militar – as denúncias podem ser feitas pelo telefone 190.</li>
                        <li className="mb-4">RENCTAS - Rede Nacional Contra o Tráfico de Animais Silvestres - 61 3550-7227.</li>
