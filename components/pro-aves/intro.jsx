        ...
        <AccordionItem>
            ...
            <AccordionPanel>
                <div className="px-6 text-gray-600">
                    <Fig section="intro (copy)" number={2} legend={
                    ...
                    <Fig section="intro (copy)" number={3} size={"large"} legend={
                    ...
                    <Fig section="intro (copy)" number={4} legend={
                    ...
                    <Fig section="intro (copy)" number={5} size="large" legend={
...
const ImageGrid = (props) => {
    ...
    const image = require(`public/proaves/intro (copy)/fig${fig}.jpg`)
