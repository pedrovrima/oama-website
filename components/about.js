    ...
    <section class=" py-8">
      <div class="container max-w-4xl mx-auto ">
        ...
        <p className="text-gray-600 text-lg mb-8 p-6">
          ...
          conservação. <br />
          Acreditamos que a melhor forma de tomar decisões e planejar ações para
          a conservação da biodiversidade é sob a luz do conhecimento. A
          pesquisa científica é a ferramenta que usamos para buscar, adquirir e
